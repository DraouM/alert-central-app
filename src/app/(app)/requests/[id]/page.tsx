...
import { User, MapPin, AlertTriangle, CalendarDays, Phone, MessageSquare, Image as ImageIcon, PlayCircle, Users, Map as MapIcon } from "lucide-react";
        ...
        <div className="md:col-span-2 space-y-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    {request.imageUrls.map((url, index) => (
                      <div key={index} className="aspect-square relative rounded-md overflow-hidden border">
                        <Image src={url} alt={`Incident image ${index + 1}`} layout="fill" objectFit="cover" data-ai-hint="accident photo"/>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent>
                ...
                <div className="mt-4 aspect-[16/9] w-full bg-muted rounded-md overflow-hidden flex items-center justify-center">
                    <Image src="https://placehold.co/600x338.png" alt="Team Tracking Map Placeholder" width={600} height={338} className="object-cover w-full h-full" data-ai-hint="map route" />
                </div>
                <p className="text-sm text-muted-foreground mt-1 text-center">Live tracking of responding team (Placeholder).</p>
            </CardContent>
          </Card>
